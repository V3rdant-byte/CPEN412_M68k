; D:\CPEN412\M68K\PROGRAMS\DEMOCO\LAB6B.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include "DM.h"
; #include "canbus.H"
...
; SPI_Control = (unsigned char) 0x53; // 0101_0011
       move.b    #83,4227104
; SPI_Ext = (unsigned char) 0x00; // 00_0000_00
       clr.b     4227110
; Disable_SPI_CS();
       move.b    #255,4227112
...
; {
       xdef      _SendFlashCmdAndAddr
_SendFlashCmdAndAddr:
       link      A6,#0
       movem.l   D2/A2,-(A7)
...
; Address = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D2
; if(Address > 0x1FFFF ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D2
       bls.s     WriteI2C_1
...
; c = Get2HexDigits(0);
       ...
       addq.w    #4,A7
       move.b    D0,D5
; if(Address > 0xFFFF){ //Chip is consisted of 2 x 64kB blocks which is the high and low block
       cmp.l     #65535,D2
       bls       WriteI2C_4
...
; AddressFrom = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D3
; if(AddressFrom > 0x1FFFF ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D3
...
; AddressTo = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D2
; if(AddressTo > 0x1FFFF ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D2
...
SeqReadI2C_4:
; } 
; if(AddressFrom > 0xFFFF){ //Chip is consisted of 2 x 64kB blocks which is the high and low block
       cmp.l     #65535,D2
       bls.s     SeqReadI2C_6
...
; //     Can0_TxBuffer3 = 0x31; /* data1 = 51 */
; //     Can0_TxBuffer4 = 0x41; /* data2 = 52*/
; //     Can0_TxBuffer10 = 0x11; /* data8 = 58 */
...
; InstallExceptionHandler(Check, 24);                            // install spurious IRQ exception handler
       ...
       jsr       (A2)
       addq.w    #8,A7
; InstallExceptionHandler(Timer_ISR_1, 27);
       pea       27
       pea       _Timer_ISR_1.L
       jsr       (A2)
       addq.w    #8,A7
...
@lab6b_22:
       dc.b      46,0
@lab6b_23:
       dc.b      10,13,69,114,97,115,105,110,103,10,13,0
@lab6b_24:
       dc.b      87,114,105,116,105,110,103,32,80,114,111,103
       dc.b      114,97,109,32,116,111,32,109,101,109,111,114
       dc.b      121,32,10,13,0
@lab6b_25:
       dc.b      87,114,105,116,105,110,103,32,68,111,110,101
       dc.b      10,13,0
@lab6b_26:
       dc.b      82,101,97,100,105,110,103,32,80,114,111,103
       dc.b      114,97,109,32,102,114,111,109,32,109,101,109
       dc.b      111,114,121,10,13,0
@lab6b_27:
       dc.b      13,10,69,82,82,79,82,58,32,68,65,84,65,32,77
       dc.b      105,115,109,97,116,99,104,32,97,116,32,97,100
       dc.b      100,114,32,48,120,37,48,56,120,46,32,87,82,73
       dc.b      84,69,58,32,48,120,37,48,50,120,32,82,69,65
       dc.b      68,58,32,48,120,37,48,50,120,13,10,0
@lab6b_28:
       dc.b      80,65,83,83,10,13,0
@lab6b_29:
