; D:\CPEN412\M68K\PROGRAMS\DEMOCO\LAB3.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include "DM.h"
; // use 08030000 for a system running from sram or 0B000000 for system running from dram
; // #define StartOfExceptionVectorTable 08030000
...
; StartPtrByte = (int)Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D5
; if(StartPtrByte < (int)(0x09000000) || StartPtrByte > (int)(0x097FFFFF)){
       cmp.l     #150994944,D5
       blo.s     MemoryTest_26
       cmp.l     #159383551,D5
       bls.s     MemoryTest_24
...
; EndPtrByte = (int)Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,-68(A6)
; if(EndPtrByte < (int)(0x09000000) || EndPtrByte > (int)(0x097FFFFF)){
       move.l    -68(A6),D0
       cmp.l     #150994944,D0
       blo.s     MemoryTest_31
       move.l    -68(A6),D0
...
; StartPtrWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D4
; while(StartPtrWord < (int)(0x09000000) || StartPtrWord > (int)(0x097FFFFF)){
MemoryTest_57:
       cmp.l     #150994944,D4
       blo.s     MemoryTest_60
       cmp.l     #159383551,D4
...
; EndPtrWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,A5
; while(EndPtrWord < (int)(0x09000000) || EndPtrWord > (int)(0x097FFFFF)){
MemoryTest_65:
       move.l    A5,D0
       cmp.l     #150994944,D0
       blo.s     MemoryTest_68
...
; StartPtrLongWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D3
; while(StartPtrLongWord < (int)(0x09000000) || StartPtrLongWord > (int)(0x097FFFFF)){
MemoryTest_96:
       cmp.l     #150994944,D3
       blo.s     MemoryTest_99
       cmp.l     #159383551,D3
...
; EndPtrLongWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,A3
; while(EndPtrLongWord < (int)(0x09000000) || EndPtrLongWord > (int)(0x097FFFFF)){
MemoryTest_104:
       move.l    A3,D0
       cmp.l     #150994944,D0
...
@lab3_161:
       ...
       dc.b      32,97,100,100,114,101,115,115,32,119,105,116
       dc.b      104,105,110,32,48,120,48,57,48,48,48,48,48,48
       dc.b      32,45,32,48,120,48,57,55,70,70,70,70,70,58,32
...
@lab3_163:
       ...
       dc.b      100,100,114,101,115,115,32,119,105,116,104,105
       dc.b      110,32,48,120,48,57,48,48,48,48,48,48,32,45
       dc.b      32,48,120,48,57,55,70,70,70,70,70,58,32,40,69
