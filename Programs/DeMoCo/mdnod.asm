; D:\CPEN412\M68K\PROGRAMS\DEMOCO\MDNOD.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include "DM.h"
...
; unsigned char *mem_byteptr;
; // TODO
; // test data pattern
; // for (mem_byteptr = 0x08020000; mem_byteptr < 0x08030000; mem_byteptr++) // populating every two addresses for test purposes
; // {
; //     *mem_byteptr = 0; // set every byte in memory to zero
; // }
...
; printf("\r\n#");
       ...
       jsr       (A2)
       addq.w    #4,A7
; input_char = (char) _getch();
       jsr       __getch
       move.b    D0,D4
; if(input_char == (char)('1')){
       cmp.b     #49,D4
       bne.s     MemoryTest_8
; data = 0x55;
       moveq     #85,D2
...
@mdnod_137:
       dc.b      13,10,67,104,111,111,115,101,32,100,97,116,97
       dc.b      32,112,97,116,116,101,114,110,58,32,13,10,49
       dc.b      58,32,53,53,13,10,50,58,32,65,65,13,10,51,58
       dc.b      32,70,70,13,10,52,58,32,48,48,0
@mdnod_138:
...
@mdnod_143:
       dc.b      13,10,66,121,116,101,32,87,114,105,116,101,32
       dc.b      70,105,110,105,115,104,101,100,46,32,82,101
       dc.b      97,100,32,115,116,97,114,116,115,46,0
@mdnod_144:
       dc.b      13,10,98,121,116,101,100,97,116,97,58,32,37
       dc.b      120,0
@mdnod_145:
       dc.b      13,10,87,114,105,116,101,58,32,37,120,32,116
       dc.b      111,32,97,100,100,114,32,37,120,0
@mdnod_146:
       dc.b      13,10,87,111,114,100,32,87,114,105,116,101,32
       dc.b      70,105,110,105,115,104,101,100,46,32,82,101
       dc.b      97,100,32,115,116,97,114,116,115,46,0
@mdnod_147:
       dc.b      13,10,119,111,114,100,100,97,116,97,58,32,37
       dc.b      120,0
@mdnod_148:
       dc.b      13,10,76,111,110,103,32,87,111,114,100,32,87
       dc.b      114,105,116,101,32,70,105,110,105,115,104,101
       dc.b      100,46,32,82,101,97,100,32,115,116,97,114,116
       dc.b      115,46,0
@mdnod_149:
       dc.b      13,10,108,111,110,103,100,97,116,97,58,32,37
       dc.b      120,0
@mdnod_150:
       dc.b      13,10,66,121,116,101,32,82,101,97,100,32,99
       dc.b      111,109,112,108,101,116,101,46,0
@mdnod_151:
       dc.b      13,10,80,65,83,83,46,0
@mdnod_152:
       dc.b      13,10,69,82,82,79,82,58,32,65,100,100,114,101
       dc.b      115,115,32,37,120,32,100,97,116,97,32,105,115
       dc.b      32,37,120,32,98,117,116,32,115,104,111,117,108
       dc.b      100,32,98,101,32,37,120,0
@mdnod_153:
       dc.b      13,10,70,65,73,76,46,0
@mdnod_154:
       dc.b      13,10,82,101,97,100,58,32,65,100,100,114,101
       dc.b      115,115,32,37,120,32,100,97,116,97,32,105,115
       dc.b      32,37,120,0
@mdnod_155:
       dc.b      13,10,87,111,114,100,32,82,101,97,100,32,99
       dc.b      111,109,112,108,101,116,101,46,0
@mdnod_156:
       dc.b      13,10,76,111,110,103,32,87,111,114,100,32,82
       dc.b      101,97,100,32,99,111,109,112,108,101,116,101
       dc.b      46,0
@mdnod_157:
